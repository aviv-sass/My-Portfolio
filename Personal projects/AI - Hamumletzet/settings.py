...
class Settings:
    ...
    def __init__(self):
        ...
        self.MAX_AVAILABLE_COURSES_UP_TO_23_POINTS = 6
        self.MAX_AVAILABLE_COURSES_24_TO_46_POINTS = 8
        self.MAX_AVAILABLE_COURSES_47_TO_79_POINTS = 8
        self.MAX_AVAILABLE_COURSES_80_TO_112_POINTS = 8
        self.MAX_AVAILABLE_COURSES_FROM_113_POINTS = 10
        ...
        for flag in flags.keys():
            ...
            if flag == "max available courses":
                if flags[flag] == "default":
                    if remaining_points <= 23:
                        self.MAX_AVAILABLE_COURSES = self.MAX_AVAILABLE_COURSES_UP_TO_23_POINTS
                    elif 24 <= remaining_points <= 46:
                        self.MAX_AVAILABLE_COURSES = self.MAX_AVAILABLE_COURSES_24_TO_46_POINTS
                    elif 47 <= remaining_points <= 79:
                        self.MAX_AVAILABLE_COURSES = self.MAX_AVAILABLE_COURSES_47_TO_79_POINTS
                    elif 80 <= remaining_points <= 112:
                        self.MAX_AVAILABLE_COURSES = self.MAX_AVAILABLE_COURSES_80_TO_112_POINTS
                    elif remaining_points >= 113:
                        self.MAX_AVAILABLE_COURSES = self.MAX_AVAILABLE_COURSES_FROM_113_POINTS
                else:
